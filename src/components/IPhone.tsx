...
// Define the GLTF result type without three-stdlib dependency
type GLTFResult = {
...
function IPhone(props: IPhoneProps) {
  ...
  useEffect(() => {
    ...
    Object.entries(materials).forEach(([materialName, material]) => {
      ...
      if (!unchangeableMaterials.includes(materialName)) {
        // Check if material has color property before setting it
